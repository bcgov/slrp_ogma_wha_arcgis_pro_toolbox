...
def section_2_check_change_attribute_fields():
    ...
    description=(
        ...
        "Change_Management_Attributes.pdf and Section 2.7 of the OGMA Update Process doc: \n"
        "     (1) STATUS must "
        "match MODIFICATION_TYPE -- NEW/MODIFIED/MODIFIED_NOREPLACE must be STATUS=Current, and "
        "RETIREMENT/PERMANENT RETIREMENT must be STATUS=Retired;\n"
         "    (2) Current features must have "
        "GIS_CHANGE_DATE, GIS_CHANGE_PERSON, CHANGE_REASON, and INITIATOR_OF_CHANGE filled in, and must NOT "
        "have any of the four RETIREMENT_* fields filled in; \n"
         "    (3) Retired features must have the four "
        "RETIREMENT_* fields filled in; \n"
        "(4) IDIR usernames in all IDIR NAME fields must be uppercase.\n\n"
